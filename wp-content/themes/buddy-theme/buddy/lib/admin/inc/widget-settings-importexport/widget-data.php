...
class Widget_Data {
	...
	function add_admin_scripts( $hook ) {
		if ( 'tools_page_widget-settings-import' != $hook || 'tools_page_widget-settings-export' != $hook ) {
			wp_register_style( 'widget_data_css', get_template_directory_uri().'/lib/admin/inc/widget-settings-importexport/widget-data.css' ); // MODIFIED
			wp_enqueue_style( 'widget_data_css' );
			wp_register_script( 'widget_data', get_template_directory_uri().'/lib/admin/inc/widget-settings-importexport/widget-data.js' ); // MODIFIED
