...
function gp_contact_form($atts, $content = null) {
	...
	if(isset($emailSent) && $emailSent == true) {
		...
		$out .= '<p><label class="textfield_label" for="contactName">'.__('Name', 'gp_lang').' <span class="required">*</span></label><input type="text" name="contactName" id="contactName" placeholder="'.__('Name', 'gp_lang').'" value="';
		...
		// Email
		$out .= '<p><label class="textfield_label" for="contactEmail">'.__('Email', 'gp_lang').' <span class="required">*</span></label><input type="text" name="contactEmail" id="contactEmail" placeholder="'.__('Email', 'gp_lang').'" value="';
		...
		// Comments
		$out .= '<p><label class="textfield_label" for="contactComment">'.__('Comment', 'gp_lang').' <span class="required">*</span></label><textarea name="comments" id="commentsText" rows="5" cols="40" placeholder="'.__('Comment', 'gp_lang').'" class="requiredFieldContact textarea';
