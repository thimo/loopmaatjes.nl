...
function gp_columns($atts, $content = null, $code) {
	...
	if($clear === false) {			
		$out .= '<div class="columns '.$class.' '.$col_type.' '.$name.' '.$text_align.'" style="'.$margins.'"><div style="'.$height.$padding.$background.$border_width.'">'.do_shortcode($content).'<div class="clear"></div></div></div>';
	} else {
